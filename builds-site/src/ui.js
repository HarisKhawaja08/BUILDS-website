...
export const styles = {
  ...
  calMonth: { marginBottom: 40 },
  calMonthHead: { fontFamily: serif, fontSize: 22, fontWeight: 700, color: "var(--ink)", borderBottom: "2px solid var(--border)", paddingBottom: 10, marginBottom: 18, display: "flex", alignItems: "baseline", gap: 12 },
  calMonthYear: { fontFamily: utility, fontSize: 12, letterSpacing: 1.5, color: "var(--ink-faint)", fontWeight: 600 },
  calEvent: { display: "flex", gap: 18, background: "var(--surface)", border: "1px solid var(--border)", borderLeft: "3px solid var(--accent)", padding: "18px 20px", marginBottom: 10 },
  calEventDate: { fontFamily: utility, fontSize: 12, letterSpacing: 0.5, color: "var(--accent)", fontWeight: 600, marginBottom: 4, display: "flex", alignItems: "center", gap: 8 },
  calEventTitle: { fontFamily: serif, fontWeight: 700, fontSize: 18, color: "var(--ink)" },
  calEventMeta: { display: "flex", gap: 16, fontFamily: utility, fontSize: 12, color: "var(--ink-muted)", marginTop: 6, flexWrap: "wrap" },
  calEventMotion: { fontSize: 14, fontStyle: "italic", color: "var(--ink-muted)", marginTop: 6 },
